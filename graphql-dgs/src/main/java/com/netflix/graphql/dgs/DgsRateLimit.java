...
/**
 * Mark a method to be shield by a Custom Rate Limiting Logic
 * A Rate Limiter can be used to .
...
@Inherited
public @interface DgsRateLimit {
    String field();

    // Expressed in number of operations per second
    String ops() default "100";
}
